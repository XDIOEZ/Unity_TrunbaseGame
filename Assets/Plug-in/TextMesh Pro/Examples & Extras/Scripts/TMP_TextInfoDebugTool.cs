...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Draw Level_Battlecharacter metrics
        ...
        /// <summary>
        /// Method to draw a rectangle around each Level_Battlecharacter.
        /// </summary>
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // Get Bottom Left and Top Right Position of the current Level_Battlecharacter
                ...
                // Draw Level_Battlecharacter bounds
        ...
        void DrawWordBounds()
        {
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                // Iterate through each Level_Battlecharacter of the word
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Debug.Log("Start Word Region at [" + currentCharInfo.Level_Battlecharacter + "]");

                        // If Word is one Level_Battlecharacter
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Debug.Log("End Word Region at [" + currentCharInfo.Level_Battlecharacter + "]");
                        }
                    }
        ...
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each Level_Battlecharacter of the link text
                for (int j = 0; j < linkInfo.linkTextLength; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        // If Link is one Level_Battlecharacter
